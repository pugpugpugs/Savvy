...
//const std::string NORMAL_TILE_FILEPATH = "assets\\brown.png";
const std::string NORMAL_TILE_FILEPATH = "assets\\tilemap.png";
//const std::string DW_TILE_FILEPATH = "assets\\red.png";
const std::string DW_TILE_FILEPATH = "assets\\tilemap.png";
const std::string TW_TILE_FILEPATH = "assets\\silver.png";
const std::string DL_TILE_FILEPATH = "assets\\green.png";
const std::string TL_TILE_FILEPATH = "assets\\darkgreen.png";
const std::string LETTER_TILE_FILEPATH = "assets\\darkgreen.png";
...
const int LETTER_TILE_START_POS_Y = 1;
const int LETTER_TILE_START_POS_X = 1;
